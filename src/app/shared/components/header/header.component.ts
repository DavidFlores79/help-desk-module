                ...
                @if (showUserMenu) {
                  <div class="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                    ...
                    <a routerLink="/settings" 
                       ...
                       class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 ml-2">
                      <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button 
                      (click)="logout()"
                      class="w-full flex items-center gap-2 px-4 py-2 text-sm text-danger-700 hover:bg-danger-50 ml-2">
                      <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
